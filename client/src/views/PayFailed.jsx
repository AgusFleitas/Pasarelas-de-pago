...
const PayFailed = () => {
    return (
        <section className="flex flex-col justify-center items-center">
            <h1 className="font-bold text-4xl text-center text-balance mb-8">Pago no realizado</h1>
            <div className="border-2 bg-white border-sky-300/60 rounded-md md:w-96 flex flex-col justify-center items-center py-4 p-8 shadow-md shadow-gray-400">
                <strong className="text-2xl mb-2 text-red-500">¡Oh no!</strong>
                <p className='text-center text-pretty'>La operación no pudo concretarse, el pago ha sido cancelado.</p>
