const Credentials = () => {
  return (
    <section className='flex flex-col justify-center'>
      ...
      <div className='grid grid-cols-2 grid-rows-2 mx-auto gap-x-6 gap-y-4 auto-rows-[24rem]'>
        <article className='w-80 row-span-2 bg-white border-2 border-[#00B1EA] flex flex-col items-center justify-around py-2 px-4 rounded-md shadow-md shadow-gray-400'>
        ...
        <article className=' bg-white border-2 border-[#003087] flex flex-col items-center justify-around p-4 rounded-md shadow-md shadow-gray-400'>
          <h3 className='text-center font-semibold text-xl'>PayPal</h3>
          <div className='w-full'>
            <div className='w-full flex flex-col gap-y-1 justify-between'>
              <strong>Correo:</strong>
              <p>sb-szavk32087050@personal.example.com</p>
            </div>
            <div className='w-full flex flex-col gap-y-1 justify-between'>
              <strong>Contraseña:</strong>
              <p>4'tlA(?%</p>
        ...
        <span className="self-center font-semibold bg-yellow-400/40 text-center text-balance rounded-md py-1 px-2 mt-24">Estos datos son para realizar pruebas, no pertenecen a ninguna persona y no son admitidos en transacciones reales. Por favor, no intentes realizar ningún pago con estos datos.</span>
    </section>
  );
};
